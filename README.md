...
<p align="center">
  ...
  <a href="#test-coverage"><img src="https://img.shields.io/badge/tests-575_passing-00d4aa?style=flat-square" alt="Tests"></a>
...
Automatic detection of 18+ PII types across Norwegian, US, and European jurisdictions. Each match gets a confidence score and risk level (low / medium / high / critical).
...
Detected types include: Norwegian FNR, email, phone, SSN, credit card, IBAN, API keys, auth tokens, passwords, IP addresses, and more.
...
+-- tests/
|   +-- python/                   162 tests (core, PQC, subscription, PII, entropy)
+-- scripts/
...
| Python entropy (quota, scheduler) | 20 | Passing |
| Python quantum random | 18 | Passing |
| Python PII scanner | 10 | Passing |
| Python multi-provider | 16 | Skipped (needs external deps) |
| **Total Python** | **162** | **Passing** |
| **Grand Total** | **575** | |
...
Enterprise features (Flutter apps, browser, VPN, mail, HSM, SSO) require a separate commercial license. Contact [enterprise@zipminator.zip](mailto:enterprise@zipminator.zip).
