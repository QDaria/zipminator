...
export const SectionResearch = () => (
  <div className="space-y-10">
    ...
    >
      Three peer-reviewed-quality research papers have been published on the IACR Cryptology
      ePrint Archive, the standard venue for cryptographic pre-prints. Each paper underpins
      one patent, providing the mathematical proofs and experimental validation that strengthen
      the IP position and academic credibility.
    </motion.p>
