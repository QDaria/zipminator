...
/// Ciphertext = compressed u (d_u=10) + compressed v (d_v=4)
/// = k*n*d_u/8 + n*d_v/8 = 3*320 + 128 = 1088
pub const KYBER768_CIPHERTEXTBYTES: usize = KYBER_K * (KYBER_N * 10 / 8) + (KYBER_N * 4 / 8);
