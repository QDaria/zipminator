...
\copyrightyear{2026}
\acmYear{2026}
\acmConference[WiSec '26]{19th ACM Conference on Security and Privacy in Wireless and Mobile Networks}{July 2026}{TBD}
...
\affiliation{%
  \institution{QDaria Quantum Research}
  \city{Oslo}
  \country{Norway}
}
...
The extraction pipeline, Von~Neumann debiaser, pool architecture, PUEK enrollment code, and XOR compositor are open-source components of the \zipminator project, available at \url{https://github.com/QDaria/zipminator}.
...
All source code for the extraction pipeline (Python and Rust), NIST SP~800-90B assessment scripts, PUEK enrollment and verification, and the XOR compositor are available in the open-source repository.
